...
/// <summary>Tells the client a single block changed to the given block-state id.</summary>
public sealed record BlockUpdateS2C(Vector3i Position, int BlockStateId) : IMessage;
...
/// </summary>
public sealed record SetItemEntityMetadataS2C(int EntityId, int ItemId, int Count) : IMessage;

/// <summary>Spawns a non-living entity (e.g. a dropped item) on the client.</summary>
public sealed record SpawnEntityS2C(
    ...
    int Data,
    short VelocityX, short VelocityY, short VelocityZ) : IMessage;
