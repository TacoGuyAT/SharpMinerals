...
public static class EntityRegistry {
    ...
    /// <summary>The built-in entity kinds, registered (with their ECS component recipes) by <see cref="CoreMod"/>
    /// - the engine mod, loaded first - so they're non-null after engine init. Their wire ids are still mapped to
    /// vanilla by the type mapper (sharpminerals:item-&gt;54, falling_block-&gt;36, player-&gt;spawn).</summary>
