...
/// <summary>
/// An entity's inventory layout over a backing <see cref="Inventory"/>: 36 main slots
...
public sealed class EntityInventory {
    ...
    public ItemStack Add(ItemStack stack) {
        for (int i = 0; i < MainSize && !stack.IsEmpty; i++) {
            ...
            if (!dst.IsEmpty && dst.Type == stack.Type && dst.Count < dst.Type!.MaxStackSize) {
