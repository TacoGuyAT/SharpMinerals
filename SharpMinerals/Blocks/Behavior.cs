...
/// <summary>
/// The context handed to a block behavior when an event fires: which world/position,
/// the block definition involved, and the acting entity (default = none).
/// </summary>
...
/// <summary>
/// Dispatches a behavior event to whichever of a definition's components implement it.
/// Allocation-free: a plain iteration over the component set.
/// </summary>
